...
* Course selection based on the academic plan
* Interactive college map with multiple floors
* Digital creatures with course-related questions
* Training section for incorrect answers
* Achievements and medals page
* Leaderboard system
